...
- [`html/`](html/)
  ...
  - [`test2.evgeniy-khyst.com/`](html/services.homellc/) - directory mounted as a webroot for `test2.evgeniy-khyst.com`. Configured in `vhosts/test2.evgeniy-khyst.com.conf`
    - [`index.html`](html/services.homellc/index.html)
- [`certbot/`](certbot/)
